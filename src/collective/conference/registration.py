...
class IRegistrationForm(Interface):
    ...
    privacypolicytext = schema.Text(
            ...
            description=_(u"The data entered during registration is used for the purposes of organizing the conference. Users may be informed via email about the conference, the registration, and technical circumstances. The data is collected as shown in the relative input boxes during the registration. You agree that this data will be processed by The Document Foundation and forwarded to the association Freies Office Deutschland e.V., the German Federal Ministry of Economics and Technology, and the German Federal Ministry of the Interior for the purpose of organizing the conference and for ensuring the safety of the conference, including access control. Revocation, Changes, Corrections, and Updates The user has the right to receive, free of charge, information about his stored personal data. In addition, the user has the right to demand inaccurate data to be corrected, and personal data to be blocked or deleted, as long as there is no legal obligation to retain the data. To do so, write to info@
documentfoundation.org. The organizers of the conference reserve the right to revoke the registration of conference participants in this case."),
            readonly=True,
            required=False,
        ) 
