...
from collective.conference.program import startDefaultValue
from collective.conference.program import endDefaultValue
from collective.conference.program import IProgram
from collective.conference.program import StartBeforeEnd
...
class TestProgramIntegration(unittest.TestCase):
    ...
    def test_view(self):
        ...
        tracks = view.tracks()
        self.assertEquals(0, len(tracks))
